  ...
  return (
    <div className="relative h-auto w-auto flex flex-col">
      ...
      <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
        <div className="grid items-center justify-items-center mt-28 md:mt-23 sm:mt-20">
          ...
          <button
            type="button"
            className="button-theme bg-slate-200 shadow-slate-200 rounded-xl mt-5 sm:mt-2 mb-10 "
          >
            {btntext}
          </button>
          ...
          <div className="">
            <div className="grid items-center gap-3 md:gap-3 absolute top-[33vh] lg:top-[27vh] right-[11%] xl:right-0 w-auto h-auto  ">
