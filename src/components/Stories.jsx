...
import { ClockIcon, HashtagIcon, HeartIcon } from "@heroicons/react/16/solid";
          ...
          <Splide options={splideOptions}>
            {news?.map((val, i) => (
              <SplideSlide key={i} className="mb-0.5">
                <div className="relative grid items-center rounded-lg shadow-slate-200 shadow gap-4 pb-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      <ClockIcon className="icon-style w-4 h-4 text-slate-400" />{" "}
