...
const CartItem = ({
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full px-3 md:px-5 border-2 py-3 border-slate-300 rounded-2xl  ">
        <div className="flex items-center gap-5">
          <div
            className={`bg-gradient-to-b ${color} ${shadow} relative rounded-lg p-3 hover:scale-105 transition-all duration-75 ease-in-out grid items-center `}
          >
            <img
              src={img}
          ...
          <div className="grid items-center gap-4">
            <div className="grid items-center leading-none">
              <h1 className="font-bold text-lg text-slate-900 lg:text-sm sm:text-xs">
                {title}
              </h1>
